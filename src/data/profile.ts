...
export const profileData: Profile = {
  ...
  about: [
    "I'm an AI Engineer and full-stack developer based in Kathmandu, Nepal, currently teaching IT at G-Tech I.T Solution. My work spans the full AI lifecycle: training deep learning models, wiring retrieval-augmented generation pipelines, and shipping the React + Node systems that make them useful.",
